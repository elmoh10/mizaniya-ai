...
export function App() {
  ...
  const [timeline] = useState<InsightTimelineItem[]>([]);
  ...
  const loadAppData = useCallback(async () => {
    ...
    try {
      const [walletsRes, txsRes, budgetRes, goalsRes, billsRes, subsRes, healthRes] = await Promise.all([
            ...
            <>
              ...
              {activeTab === 'bills' && (
                <BillsView
                  ...
                  lang={lang}
                  onRefreshBills={loadAppData}
                  onRefreshSubscriptions={loadAppData}
                />
              )}
